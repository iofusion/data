    ...
    if (isStableIdentifier(resource)) {
      if (DEBUG) {
        ...
        if (!(resource.lid in this._cache.lids) || this._cache.lids[resource.lid] !== resource) {
          throw new Error(
            `The supplied identifier ${resource} does not belong to this store instance`
          );
        }
      }
      return resource;
  ...
  */
  createIdentifierForNewRecord(data: NewResourceObject): StableRecordIdentifier {
    ...
    if (DEBUG) {
      if (identifier.lid in this._cache.lids) {
        throw new Error(
          `The lid generated for the new record fails to be unique as it matches an existing identifier`
        );
      }
    }
    this._cache.lids[identifier.lid] = identifier;
...
function isStableIdentifier(
  identifier: StableRecordIdentifier | Object
